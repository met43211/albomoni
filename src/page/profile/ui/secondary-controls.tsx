    ...
    <div className='w-full grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 -mt-[11px]'>
      ...
      <Link href='/profile/subscriptions' className='col-span-2 md:col-span-1'>
        <button
          type='button'
          aria-label='my-ads'
          className='w-full h-24 md:h-36 rounded-[20px] flex flex-col shadow-base dark:bg-default text-start font-medium p-4 relative overflow-clip justify-between hover:scale-[1.02] active:scale-[0.98] transition-transform'
        >
